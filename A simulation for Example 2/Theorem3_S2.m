...
in = 0;
    ...
    c(in*10 + 1)  = Xk_(1,1);
    c(in*10 + 2)  = Xk_(1,2) + Xk_(2,1);
    c(in*10 + 3)  = Xk_(2,2);
    c(in*10 + 4)  = Xk_(1,3) + Xk_(3,1);
    c(in*10 + 5)  = Xk_(2,3) + Xk_(3,2);
    c(in*10 + 6)  = Xk_(3,3);
    c(in*10 + 7)  = Xk_(1,4) + Xk_(4,1);
    c(in*10 + 8)  = Xk_(2,4) + Xk_(4,2);
    c(in*10 + 9)  = Xk_(3,4) + Xk_(4,3);
    c(in*10 + 10) = Xk_(4,4);
    in = in + 1;

    c(in*10 + 1)  = Xk(1,1);
    c(in*10 + 2)  = Xk(1,2) + Xk(2,1);
    c(in*10 + 3)  = Xk(2,2);
    c(in*10 + 4)  = Xk(1,3) + Xk(3,1);
    c(in*10 + 5)  = Xk(2,3) + Xk(3,2);
    c(in*10 + 6)  = Xk(3,3);
    c(in*10 + 7)  = Xk(1,4) + Xk(4,1);
    c(in*10 + 8)  = Xk(2,4) + Xk(4,2);
    c(in*10 + 9)  = Xk(3,4) + Xk(4,3);
    c(in*10 + 10) = Xk(4,4);
    in = in + 1;
